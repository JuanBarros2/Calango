...
actionGame(FOOD, CLEAR, ENERGY, LOVE, _, NFOOD, NCLEAR, NENERGY, NLOVE, NSLEEP, 1):-
    NFOOD is FOOD + 25,
    NCLEAR is CLEAR,
    NENERGY is ENERGY,
    NLOVE is LOVE + 5,
    NSLEEP=false.
actionGame(FOOD, _, ENERGY, LOVE, _, NFOOD, NCLEAR, NENERGY, NLOVE, NSLEEP, 2):-
    NFOOD is FOOD,
    NCLEAR is 100,
    NENERGY is ENERGY,
    NLOVE is LOVE + 5,
    NSLEEP=false.
actionGame(FOOD, CLEAR, ENERGY, LOVE, _, NFOOD, NCLEAR, NENERGY, NLOVE, NSLEEP, 4):-
    NFOOD is FOOD,
    NCLEAR is CLEAR,
    NENERGY is ENERGY,
    NLOVE is LOVE + 40,
    NSLEEP=false.
actionGame(FOOD, CLEAR, ENERGY, LOVE, _, NFOOD, NCLEAR, NENERGY, NLOVE, NSLEEP, 3):-
    NFOOD is FOOD,
    NCLEAR is CLEAR,
    NENERGY is ENERGY + 20,
    NLOVE is LOVE,
    NSLEEP=true.
...
actionSleep(NAME, FOOD, CLEAR, ENERGY, LOVE, LIFE, SLEEP, 2):-
    ...
    decreaseTurn(NCLEAR, NFOOD, NENERGY, NLOVE, DCLEAR, DFOOD, DENERGY, DLOVE),
    mainCircle(NAME, DCLEAR, DFOOD, DENERGY, DLOVE, LIFE, NSLEEP).
actionSleep(NAME, FOOD, CLEAR, ENERGY, LOVE, LIFE, _, 1):-
    NFOOD is FOOD,
    NCLEAR is CLEAR,
    NENERGY is ENERGY,
    NLOVE is LOVE + 5,
...
decreaseTurn(FOOD, CLEAR, ENERGY, LOVE, NFOOD, NCLEAR, NENERGY, NLOVE):-
    NFOOD is FOOD - 5,
    NCLEAR is CLEAR - 10,
    NENERGY is ENERGY,
    NLOVE is LOVE.
